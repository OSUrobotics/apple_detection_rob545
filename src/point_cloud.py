...
class PointCloud:
	...
	def save_data(self, request):
		if request.trigger == True:
			...
			ply = rs.save_to_ply("{}/point_cloud{}.ply".format(directory_loc,self.pose_number))
...
if __name__ == "__main__":
	...
	rospy.init_node('pointcloud_node', argv=sys.argv)

	point_cloud = PointCloud()

	service = rospy.Service('collect_image', CollectImageData, point_cloud.save_data)
